...
//session part
const sessionOptions={secret:'ThisIsSecretKey',resave:false,saveUninitialized:false}
...
mongoose.connect("mongodb://127.0.0.1:27017/flashDemo",{useNewUrlParser:true,useUnifiedTopology:true},(err)=>{
    if(err)
    {
